...
export const IApgCii_PUSH_LAYER_SCHEMA_ID =
    Jsv.ApgJsv_DOMAIN + 'IApgCii_PushLayer';

const rawSchema: Jsv.IApgJsvInterface = {
    $schema: Jsv.ApgJsv_DIALECT,
    $id: IApgCii_PUSH_LAYER_SCHEMA_ID,
    type: 'object',
    properties: {
        type: {
...
export const IApgCii_PUSH_LAYER_SCHEMA = Uts.ApgUtsObj.DeepFreeze(rawSchema) as Jsv.IApgJsvInterface;