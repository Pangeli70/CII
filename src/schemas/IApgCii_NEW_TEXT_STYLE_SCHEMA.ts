...
export const IApgCii_NEW_TEXT_STYLE_SCHEMA_ID =
    Jsv.ApgJsv_DOMAIN + 'IApgCii_NewTextStyle';

const rawSchema: Jsv.IApgJsvInterface = {
    $schema: Jsv.ApgJsv_DIALECT,
    $id: IApgCii_NEW_TEXT_STYLE_SCHEMA_ID,
    type: 'object',
    properties: {
        type: {
...
export const IApgCii_NEW_TEXT_STYLE_SCHEMA = Uts.ApgUtsObj.DeepFreeze(rawSchema) as Jsv.IApgJsvInterface;