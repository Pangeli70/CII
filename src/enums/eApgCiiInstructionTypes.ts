...
export enum eApgCiiInstructionTypes {
  ...
  CAD_VIEWBOX = "CAD_VIEWBOX",
  CAD_BACKGROUND = "CAD_BACKGROUND",
  CAD_CARTESIAN_MODES = "CAD_CARTESIAN_MODES",
  CAD_CARTESIANS = "CAD_CARTESIANS",
  CAD_GRID_MODES = "CAD_GRID_MODES",
  CAD_GRID = "CAD_GRID",

  CAD_FILL_STYLE = "CAD_FILL_STYLE",
  CAD_STROKE_STYLE = "CAD_STROKE_STYLE",
  CAD_TEXT_STYLE = "CAD_TEXT_STYLE",
  CAD_PATH_ARC_OPTIONS = "CAD_PATH_ARC_OPTIONS",
  CAD_ARC_DIM_TYPES = "CAD_ARC_DIM_TYPES",
  CAD_ARC_DIM_OPTIONS = "CAD_ARC_DIM_OPTIONS",
  CAD_LIN_DIM_TYPES = "CAD_LIN_DIM_TYPES",
  CAD_DIM_POSITIONS = "CAD_DIM_POSITIONS",
  ...
  DRAW_ARC = "DRAW_ARC", // S + I // TODO @3 test -- APG 20230115
  
  PATH_BEGIN = "PATH_BEGIN",// S + I
  PATH_MOVE = "PATH_MOVE",// S + I
  PATH_LINE = "PATH_LINE",// S + I
  PATH_ARC = "PATH_ARC",// S + I
  PATH_CURSOR = "PATH_CURSOR", 
  PATH_CLOSE = "PATH_CLOSE",// S + I
  PATH_END = "PATH_END",// S + I
